...
driver.get('https://flights.makemytrip.com/makemytrip/search/O/O/E/1/0/0/S/V0/DEL_BOM_05-03-2018?contains=false&remove=')
html_page_mmt = driver.page_source
driver.get('https://flight.yatra.com/air-search-ui/dom2/trigger?ADT=1&CHD=0&INF=0&class=Economy&destination=BOM&destinationCountry=IN&flexi=0&flight_depart_date=05/03/2018&noOfSegments=1&origin=DEL&originCountry=IN&source=fresco-home&type=O&version=1.15&viewName=normal')
